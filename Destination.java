...
public class Destination extends JFrame implements Runnable {
    ...
    //JLabel caption;
    public void run(){
        String[] text=new String[]{"Trident Nariman Hotel","JW Marriott Hotel","Ramada Plaza Hotel","The Leela Hotel","Capella Bangkok Hotel"," Capella Ubud Hotel","Grace Hotel","The Oberoi Udaivilas Hotel","The Oberoi Hotel","Hotel Paracas"};
        try{
            for(int i=0;i<9;i++){
